...
This command **requires** the project directory as an argument via `/app/generations/realtt`.

**Example:** `/create-spec generations/my-app`

**Output location:** `/app/generations/realtt/.autoforge/prompts/app_spec.txt` and `/app/generations/realtt/.autoforge/prompts/initializer_prompt.md`

If `/app/generations/realtt` is empty, inform the user they must provide a project path and exit.
...
The output directory is: `/app/generations/realtt/.autoforge/prompts/`

Once the user approves, generate these files:

## 1. Generate `app_spec.txt`

**Output path:** `/app/generations/realtt/.autoforge/prompts/app_spec.txt`
...
**Output path:** `/app/generations/realtt/.autoforge/prompts/initializer_prompt.md`
...
**Output path:** `/app/generations/realtt/.autoforge/prompts/.spec_status.json`
...
> "Your specification files have been created in `/app/generations/realtt/.autoforge/prompts/`!
>
> **Files created:**
> - `/app/generations/realtt/.autoforge/prompts/app_spec.txt`
> - `/app/generations/realtt/.autoforge/prompts/initializer_prompt.md`
>
